...
class MainActivity : AppCompatActivity() {
    ...
    private fun getToolList():ArrayList<Tool>{
        ...
        toolList.add(Tool(resources.getString(R.string.qr_and_barcode_scanner),R.drawable.ic_qr_code))
        toolList.add(Tool(resources.getString(R.string.unknown_whatsapp_number),R.drawable.ic_whatsapp))
        toolList.add(Tool(resources.getString(R.string.random_text_generator),R.drawable.ic_text_editor))
